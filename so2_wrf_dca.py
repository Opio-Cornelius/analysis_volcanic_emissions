...
#Input data
model = np.load('C:/python_work/phd/paper3/real_work/so2_model_train.npy')
model_val = np.load('C:/python_work/phd/paper3/real_work/so2_model_validate.npy')
model_test = np.load('C:/python_work/phd/paper3/real_work/so2_model_test.npy')

obs = np.load('C:/python_work/phd/paper3/real_work/so2_obs_train.npy')
obs_val = np.load('C:/python_work/phd/paper3/real_work/so2_obs_validate.npy')
obs_test = np.load('C:/python_work/phd/paper3/real_work/so2_obs_test.npy')
...
#Saving autoencoder
autoencoder.save('C:/python_work/phd/paper3/real_work/ai_model/so2_ai_dca')
mse_history = history.history['mse']
val_mse_history = history.history['val_mse']
np.save('C:/python_work/phd/paper3/real_work/ai_model/mse_history', mse_history)
np.save('C:/python_work/phd/paper3/real_work/ai_model/val_mse_history', val_mse_history)
...
autoencoder_from_saved = tf.keras.models.load_model('C:/python_work/phd/paper3/real_work/ai_model/so2_ai_dca')
...
d_so2 = pd.read_csv('C:/python_work/phd/paper3/real_work/so2_amount.csv')
d_rmse = pd.read_csv('C:/python_work/phd/paper3/real_work/so2_rmse.csv')
d_bias = pd.read_csv('C:/python_work/phd/paper3/real_work/so2_bias.csv')
...
p1=plt.plot('month', 'OMI', data=d_so2, color='deeppink', linewidth=2)
plt.errorbar('month', 'OMI',  'OMI_std', data=d_so2, color='deeppink', linestyle='None', 
             marker='o', label=None, elinewidth=0.5, transform=trans1)
p2=plt.plot('month', 'WRF-Chem', data=d_so2, color='black', linewidth=2)
plt.errorbar('month', 'WRF-Chem',  'WRF-Chem_std', data=d_so2, color='black', linestyle='None', 
             marker='o', label=None, elinewidth=0.5)
p3=plt.plot('month', 'WRF-LS', data=d_so2, color='limegreen', linewidth=2)
plt.errorbar('month', 'WRF-LS',  'WRF-LS_std', data=d_so2, color='limegreen', linestyle='None', 
             marker='o', label=None, elinewidth=0.5, transform=trans3)
p4=plt.plot('month', 'WRF-DCA', data=d_so2, color='orange', linewidth=2)
plt.errorbar('month', 'WRF-DCA',  'WRF-DCA_std', data=d_so2, color='orange', linestyle='None', 
...
sc_norm = colors.TwoSlopeNorm(14.433192825869297, 0.003920678600010959, 28.870306330338604)
